...
def create_app() -> FastAPI:
    ...
    application = FastAPI(title="Research Radar", docs_url=None, redoc_url=None,
                          openapi_url=None)
    from app import (routes_admin, routes_coach, routes_journals,
                     routes_podcast, routes_public, routes_user, routes_zotero)
    ...
    application.include_router(routes_podcast.router)
